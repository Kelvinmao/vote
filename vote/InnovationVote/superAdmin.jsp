...
<body class="templatemo-bg-gray">
    ...
    <div class="container">
        <div class="col-lg-12">
            <h1 class="margin-bottom-15">大创展投票系统(管理员登录)</h1>
            <form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="loginAdmin" method="post">
