...
class ConnectionPool implements Runnable
{
	...
	db.compool.ConnectionPool.class;
        ...
        throws IOException
    {
        ...
        {
            SysLog.getLogger(thisClass).warn(
                "DbConnectionDefaultPool could not open \""
                    + logFileString
                    + "\" to write log to. Make sure that your Java "
                ...
                log =
                    new PrintWriter(
                        new FileOutputStream(
                            "DCB_" + System.currentTimeMillis() + ".log"),
                        true);
            }
    ...
    private void createConn(int i) throws SQLException
    {
        ...
        try
        {
            ...
            connPool[i] =
                DriverManager.getConnection(dbServer, dbLogin, dbPassword);
            try{
